...
export class Backend implements backendInterface {
    ...
    async getAllQualificationForms(): Promise<Array<QualificationForm>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllQualificationForms();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitQualificationForm(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string, arg6: string, arg7: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitQualificationForm(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
